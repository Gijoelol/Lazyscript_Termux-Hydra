...
bash Hydra.sh
cd /data/data/com.termux/files/home
cd /data/data/com.termux/files/home/Termux-Lazyscript
echo ""
...
echo ""
echo "$cyan and see evildevill's github for more info"
echo ""
echo "$cyan i thank them a lot (Technicalmujeeb and EvilDevil)."
